package org.jhipster.bymi.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.jhipster.bymi.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.jhipster.bymi.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, org.jhipster.bymi.domain.User.class.getName());
