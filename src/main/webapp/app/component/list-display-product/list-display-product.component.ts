...
export class ListDisplayProductComponent implements OnInit {
  ...
  ngOnInit() {
    const product1 = new Product(1, 1, 'test01', 15, 'null', 2, null, null);
    const product2 = new Product(1, 2, 'test02', 16, 'null', 2, null, null);
    const product3 = new Product(1, 3, 'test03', 95, 'null', 1, null, null);
    this.products = [];
