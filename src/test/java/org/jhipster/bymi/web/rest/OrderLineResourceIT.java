...
public class OrderLineResourceIT {
     ...
     *
     * @see org.jhipster.bymi.repository.search.OrderLineSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final OrderLineResource orderLineResource = new OrderLineResource(orderLineRepository, mockOrderLineSearchRepository);
